										...
										<tr>
											<td valign="top">
												<table border="0" cellpadding="10" cellspacing="0" width="100%">
													<tr>
														<td colspan="2" valign="middle" id="credit" class="rodapeEmail"> 

														<style>

															.rodapeEmail p {
																font-family: Helvetica; font-weight: normal; font-size: 16px !important; line-height: 25px; letter-spacing: 0px;
															}
