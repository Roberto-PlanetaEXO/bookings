...
<html <?php language_attributes(); ?>>
	...
	if ( isset( $email ) && is_a( $email, 'WC_Email_Customer_Invoice' ) ) {
		$order = $email->object;
																...
																<?php if ( ! empty( $customer_name ) ) : ?>
																	...
																	<br /><br />
																	 ...
																	 <span style="font-size: 25px; line-height: 25px;">
																	 	<?php esc_html_e( 'This is your booking number', 'woocommerce' ); ?>: <strong><?php echo $order->get_order_number(); ?></strong>
																	 </span>
